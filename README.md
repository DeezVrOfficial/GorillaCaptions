...
- Download the release from [here](https://github.com/DeezVrOfficial/GorillaCaptions/releases/latest)
...
# Credits
- Originally from [iiDk](https://github.com/iiDK-the-actual/GorillaCaptions)
